...
&nbsp;
<input name="submit2" type="button" class="btn_grey" value="查询" onClick="window.location='bookQuery.php';">
&nbsp;
<input name="submit3" type="reset" class="btn_grey" value="重置"></td>
  ...
  <div align="right"><br>
  	<p>&nbsp;</p>
  	<p>&nbsp;</p>
CopyRight  2015 lib.hzau.edu.cn &nbsp;华中农业大学图书馆 </div>
</form>
</body>
</html>
