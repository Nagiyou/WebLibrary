...
function check(form1){
	if(form1.name.value==""){
		alert("请输入用户名称!");form1.name.focus();return false;
	}
	if(form1.pwd.value==""){
		alert("请输入用户密码!");form1.pwd.focus();return false;
	}
	if(form1.pwd1.value==""){
		alert("请确认用户密码!");form1.pwd1.focus();return false;
	}		
	if(form1.pwd.value!=form1.pwd1.value){
		alert("您两次输入的用户密码不一致，请重新输入!");form1.pwd1.focus();return false;
	}
}
</script>
<body>
